...
```{r geoidUndulation, echo=FALSE, fig.cap="", out.width= '70%' }
...
If you would like to reproject your sf object, use `st_transform`
...
Area_Albers <- "find PROJ.4"
Area_Equidistant <- "find PROJ.4"
Area_Lambert <- "find PROJ.4"
Area_NYStatePlane <- "find PROJ.4"
```